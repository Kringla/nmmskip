...
Å bli i stand til å rette i redderitabellen i rederi-sok.php
...
Berørte filer er/kan være 

/user/rederi_sok.php (hovedfil)
index.php (kan bli berørt)
 


Tillatte endringer:

index.php, /user/rederi_sok.php
...
Nåværende oppførsel: Ingen mulighet for endringer av rederinavn i Rederitabellen.
Ønsket oppførsel: Ønsker at brukere i admin-rollen skal kunne endre rederinavn som listes. Det er ønskelig at det kan gjøres direkte i listen, men hvis vanskelig/umulig kan du foreslå andre måter å gjøre det på.
