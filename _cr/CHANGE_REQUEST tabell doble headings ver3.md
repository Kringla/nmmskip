...
Berørte filer (eksakt sti):  /user/fartoy_navn_sok.php, /user/fartoy_spes_sok.php, og /assets/css/app.css og /assets/css/v2/components.css
...
Nåværende oppførsel: Sidens heading og tabellen står fast på siden, og forsvinner ved scrolling av siden. "Vis" knappen uforholdsmessig stor. Feil søke elementer.

Ønsket oppførsel: Fast heading og tabell-container. Tabelloverskrift står fast ved scrolling i tabellen. Liten "Vis"-knapp (btn-small). Vil at /assets/img/spinner.gif  roterer etter søk er trykket. Det skal kun søkes på elementene FartDrift_ID, FartSkrog_ID og FartFunk_ID i alle kombinasjoner, med "alle" hvis ikke valgt!

5. Gjennomføring
Les igjennom prosjektets dokumenter referert i pkt 3 over, som også ligger som Projektets dokumentasjon. Se hvordan løsningene i fartoy_navn_sok.php er for samme problemstillinger.
