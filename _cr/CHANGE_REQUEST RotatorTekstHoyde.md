...
Hva: Ønsker å senke teksten i rotator-blokken i index.php
...
Berørte filer (eksakt sti):
 ...
 /index.php, <section class="hero hero-rotator" ....
...
Nåværende oppførsel: Teksten Rotator bruker hele skjerm-bredden
