...
Hva: Ønsker å endre fartoyspes.php
...
Berørte filer (eksakt sti): /user/fartoyspes.php.
Siste versjon av fartoyspes.php.

Tillatte endringer: Lov å å endre alt mellom FartType/FartNavn (rett under 'Fartøysspesifikasjoner') og 'Tilbake'-knapp i berørte fil.
...
Nåværende oppførsel: Grei. Refererer til Spes-ID, Skrog verft og BntSkrog som ikke er relevant.

Ønsket oppførsel:
a. Lay-out med samme "look and feel" som fartoy_edit.php. Ønsker at hoveddataene skal vises som i filen fartoy_edit.php for alle dataen fra tblFartSpes, i form av verdier fra tilhørende lenker til verdier i andre tabeller når relevant. 
b. Fjerne referanse til Spes-ID, skrog verft og BnrSkrog i visningen
