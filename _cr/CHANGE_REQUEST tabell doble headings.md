...
Berørte filer (eksakt sti): /admin/fartoy_edit.php, /user/fartoy_navn_sok.php, /user/fartoy_navn_sok.php, /assets/css/app.css og /assets/css/v2/components.css
Andre i repo kan være berørt.

Tillatte endringer: Lov å endre alle.
...
Nåværende oppførsel: Tabellene vises med doble tabell headinger. Tabell headingen står ikke fast under scroll i tabellen. Tabellenbe viser et unødvendig kolonne; 'Rederi/eier.


Ønsket oppførsel: Fast, enkeltstående tabell heading uten kolonnen 'Rederi/eier'.
