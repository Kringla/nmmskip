...
Hvorfor: For å kunne endre feil og forbedre.


2. Scope (Omfang)

Berørte filer (eksakt sti): Ny fil:/user/fartoydetaljer.php.
...
Nåværende oppførsel: "user/fartoy_spes_sok.php" vises på linje under tittel. 
Bilde av fartøy, som eksisterer med lokasjonsreferanse, vises ikke.

Ønsket oppførsel:
a. "user/fartoy_spes_sok.php" vises 
b. Et bilde med innhold enten som bilde fra relevant rad av tblxnmmfoto, eller fra \img\placeholder.jpg. Hvis relevant rad finnes i tblxnmmfoto, er filen gitt ved 'URL_Bane' & 'Bilde_Fil'.
Hero-container kan gjerne skiftes ut med noe tilsvarende (iKke nødvendigvis likt) tilvarende i andre filer.
